...
import com.echances.etouches.webservices.UpdateServiceRequest.GetServicesRequestData;
 ...
 * 
 */
public class  UpdateServiceRequest extends RetrofitSpiceRequest<Response, GetServicesRequestData>
{
    private HashMap<String, String>    params;

    public UpdateServiceRequest(HashMap<String, String> params2) {
    ...
    {
        @GET (ParamsWebService.UPDATE_SERVICE)
