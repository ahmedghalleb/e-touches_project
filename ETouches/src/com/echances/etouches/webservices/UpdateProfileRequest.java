...
import com.echances.etouches.webservices.UpdateProfileRequest.GetServicesRequestData;
 ...
 * 
 */
public class  UpdateProfileRequest extends RetrofitSpiceRequest<Response, GetServicesRequestData>
{
    private HashMap<String, String>    params;

    public UpdateProfileRequest(HashMap<String, String> params2) {
    ...
    {
        @GET (ParamsWebService.EDIT_PROFILE)
