...
import com.echances.etouches.webservices.UpdateLocationRequest.GetServicesRequestData;
 ...
 * 
 */
public class  UpdateLocationRequest extends RetrofitSpiceRequest<Response, GetServicesRequestData>
{
    private HashMap<String, String>    params;

    public UpdateLocationRequest(HashMap<String, String> params2) {
    ...
    {
        @GET (ParamsWebService.UPDATE_LOCATION)
