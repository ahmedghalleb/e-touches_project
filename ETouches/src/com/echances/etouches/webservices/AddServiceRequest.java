...
import com.echances.etouches.webservices.AddServiceRequest.GetServicesRequestData;
 ...
 * 
 */
public class  AddServiceRequest extends RetrofitSpiceRequest<Response, GetServicesRequestData>
{
    private HashMap<String, String>    params;

    public AddServiceRequest(HashMap<String, String> params2) {
    ...
    {
        @GET (ParamsWebService.ADD_SERVICE)
